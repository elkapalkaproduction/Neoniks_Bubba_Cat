...
-(void)AddCoinAtPosition:(CGPoint)pos
{
    ...
    if(!useOnlyTheFirstCoinImage)
    {
        ...
        NSMutableArray *frames = [NSMutableArray array];
        CCSpriteFrame *frame1,*frame2,*frame3,*frame4,*frame5,*frame6,*frame7,*frame8,*frame9,*frame10;
        CCSpriteFrame *frame11,*frame12,*frame13,*frame14,*frame15,*frame16,*frame17,*frame18,*frame19,*frame20;
        ...
        frame5 = [CCSpriteFrame frameWithTextureFilename:[NSString stringWithFormat:@"%@5.png",fileName] rect:rc];
        frame6 = [CCSpriteFrame frameWithTextureFilename:[NSString stringWithFormat:@"%@6.png",fileName] rect:rc];
        frame7 = [CCSpriteFrame frameWithTextureFilename:[NSString stringWithFormat:@"%@7.png",fileName] rect:rc];
        frame8 = [CCSpriteFrame frameWithTextureFilename:[NSString stringWithFormat:@"%@8.png",fileName] rect:rc];
        frame9 = [CCSpriteFrame frameWithTextureFilename:[NSString stringWithFormat:@"%@9.png",fileName] rect:rc];
        frame10 = [CCSpriteFrame frameWithTextureFilename:[NSString stringWithFormat:@"%@10.png",fileName] rect:rc];
        frame11 = [CCSpriteFrame frameWithTextureFilename:[NSString stringWithFormat:@"%@11.png",fileName] rect:rc];
        frame12 = [CCSpriteFrame frameWithTextureFilename:[NSString stringWithFormat:@"%@12.png",fileName] rect:rc];
        frame13 = [CCSpriteFrame frameWithTextureFilename:[NSString stringWithFormat:@"%@13.png",fileName] rect:rc];
        frame14 = [CCSpriteFrame frameWithTextureFilename:[NSString stringWithFormat:@"%@14.png",fileName] rect:rc];
        frame15 = [CCSpriteFrame frameWithTextureFilename:[NSString stringWithFormat:@"%@15.png",fileName] rect:rc];
        frame16 = [CCSpriteFrame frameWithTextureFilename:[NSString stringWithFormat:@"%@16.png",fileName] rect:rc];
        frame17 = [CCSpriteFrame frameWithTextureFilename:[NSString stringWithFormat:@"%@17.png",fileName] rect:rc];
        frame18 = [CCSpriteFrame frameWithTextureFilename:[NSString stringWithFormat:@"%@18.png",fileName] rect:rc];
        frame19 = [CCSpriteFrame frameWithTextureFilename:[NSString stringWithFormat:@"%@19.png",fileName] rect:rc];
        frame20 = [CCSpriteFrame frameWithTextureFilename:[NSString stringWithFormat:@"%@20.png",fileName] rect:rc];
        
        [frames addObject:frame1];[frames addObject:frame2];[frames addObject:frame3];
        [frames addObject:frame4];[frames addObject:frame5];[frames addObject:frame6];
        [frames addObject:frame7];[frames addObject:frame8];[frames addObject:frame9];
        [frames addObject:frame10];[frames addObject:frame11];[frames addObject:frame12];
        [frames addObject:frame13];[frames addObject:frame14];[frames addObject:frame15];
        [frames addObject:frame16];[frames addObject:frame17];[frames addObject:frame18];
        [frames addObject:frame19];[frames addObject:frame20];
